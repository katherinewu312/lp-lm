...
* Query about subject: what sleeps -> sleep(X), what very gray sleeps -> sleep(very(gray(X))), what is very gray and sleeps -> sleep(very(gray(X)))
...
* Query about subject: who is a genius -> solve(X,problem)
...
ex. Who did they elect president -> elect(they,X,president), What did Ronny paint black -> paint(Ronny,X,black), What did she paint aggresively -> paint(she,X,aggressively), What did his parent buy for him -> buy(parents,X,for(him))
